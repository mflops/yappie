...
const client = new OpenAI({
  baseURL: 'accounts/fireworks/models/gemma-4-26b-a4b-it',
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are a context analyzer. Your job is to summarize the key points and themes from the conversation so far in 2-3 concise sentences. Focus on the main topics and any important details that would help continue the conversation naturally.',
        },
        ...lastTenMessages,
        {
          role: 'user',
